...
public class SortingParamsDefinition {
	...
	public SortingParamsDefinition() {

		validSortByValues = new Stack<String>();

		def = new ParamsAndFiltersDefinition();

		def.addValidation(CommonParamKeys.PARAM_SORT_BY,
	 ...
	 * @return
	 */
	public SortingParamsDefinition setDefaultSort(String sortBy,
			SortOrder sortOrder) {
	...
	public ParamsAndFiltersDefinition build() {
		...
		def.addDefaultParamValue(CommonParamKeys.PARAM_SORT_ORDER,
				defaultSortOrders);
